...
export default function TeacherLeaveRequests({ user }: TeacherLeaveRequestsProps) {
  // This component is deprecated - content moved to main teacher-dashboard.tsx
  return (
    <div className="p-6">
      <div className="text-center py-12">
        <Calendar className="w-16 h-16 text-blue-500 mx-auto mb-4" />
        <h2 className="text-xl font-semibold text-gray-900 mb-2">Teacher Leave Requests</h2>
